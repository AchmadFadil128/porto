      ...
      <div className="min-h-screen bg-white pt-32 pb-20">
        <div className="container mx-auto px-6 lg:px-12">
          <div className="animate-pulse space-y-8">
            ...
            {/* Image skeleton */}
            <div className="backdrop-blur-md bg-white/70 border border-gray-200/50 rounded-3xl overflow-hidden">
      ...
      <div className="min-h-screen bg-white pt-32 pb-20 relative overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-6 lg:px-12">
          <div className="max-w-2xl mx-auto text-center">
            <div className="backdrop-blur-md bg-white/70 border border-gray-200/50 rounded-3xl shadow-lg p-16">
              <div className="w-20 h-20 bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl flex items-center justify-center mx-auto mb-6">
                <Folder className="w-10 h-10 text-white" />
              </div>
              <h1 className="text-4xl font-bold text-gray-900 mb-4">Project Not Found</h1>
              <p className="text-gray-600 text-lg mb-8">The project you're looking for doesn't exist.</p>
              <button 
  ...
  return (
    <div className="min-h-screen bg-white pt-32 pb-20 relative overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-6 lg:px-12 max-w-6xl">
        ...
        <button 
          onClick={() => router.push('/projects')}
          className="group mb-8 flex items-center gap-2 px-5 py-3 backdrop-blur-md bg-white/70 border border-gray-200/50 text-gray-700 font-medium rounded-xl hover:bg-blue-50 hover:text-blue-600 hover:border-blue-200/50 transition-all duration-300 shadow-sm hover:shadow-md"
        >
        ...
        {/* Main Image */}
        <div className="backdrop-blur-md bg-white/70 border border-gray-200/50 rounded-3xl overflow-hidden shadow-lg mb-12">
          {project.image_url ? (
            <img 
            ...
            <div className="w-full h-[32rem] flex flex-col items-center justify-center text-gray-400 bg-gray-50">
        ...
        {/* Description */}
        <div className="backdrop-blur-md bg-white/70 border border-gray-200/50 rounded-3xl shadow-lg p-8 lg:p-12 mb-12">
        ...
        <div className="flex flex-wrap gap-4 mb-16">
          ...
          <a 
            ...
            target="_blank" 
            rel="noopener noreferrer"
            className="group flex items-center gap-2 px-8 py-4 backdrop-blur-md bg-white/70 border-2 border-blue-600 text-blue-600 font-semibold rounded-xl hover:bg-blue-600 hover:text-white transition-all duration-300 hover:scale-105 shadow-md hover:shadow-lg"
          >
        ...
        <div>
          ...
          {project.screenshots && project.screenshots.length > 0 ? (
            ...
            <div className="backdrop-blur-md bg-white/70 border border-gray-200/50 rounded-3xl shadow-lg p-16 text-center">
              <Folder className="w-16 h-16 text-gray-300 mx-auto mb-4" />
              <p className="text-gray-600 text-lg">No screenshots available for this project.</p>
            </div>
          )}
        </div>
      </div>
