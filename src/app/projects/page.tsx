      ...
      <div className="min-h-screen bg-white dark:bg-dark-bg pt-32 pb-20">
        <div className="container mx-auto px-6 lg:px-12">
          ...
          <div className="max-w-3xl mb-16">
            <div className="h-12 bg-gray-200 dark:bg-dark-bg rounded-2xl w-64 mb-6 animate-pulse"></div>
            <div className="h-6 bg-gray-200 dark:bg-dark-bg rounded-xl w-full max-w-2xl animate-pulse"></div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[1, 2, 3].map((i) => (
              <div 
                key={i} 
                className="backdrop-blur-md bg-white/70 dark:bg-dark-bg-secondary/70 border border-gray-200/50 dark:border-dark-bg/50 rounded-3xl overflow-hidden shadow-lg"
              >
