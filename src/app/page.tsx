    ...
    <div className="min-h-screen bg-white relative overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-6 lg:px-12 py-20">
        ...
        <div className={`flex flex-col lg:flex-row items-center gap-16 lg:gap-24 min-h-[85vh] transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          {/* Profile Section */}
          <div className="lg:w-2/5 flex flex-col items-center lg:items-start space-y-8">
            <div className="relative group">
              {/* Glass effect profile container */}
              <div className="relative backdrop-blur-md bg-white/60 border border-gray-200/50 rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500">
            ...
            <div className="flex space-x-4">
              <a href="#" className="group p-4 backdrop-blur-md bg-white/60 border border-gray-200/50 hover:bg-blue-50/80 rounded-2xl transition-all duration-300 hover:shadow-lg">
          ...
          <div className="lg:w-3/5 text-center lg:text-left space-y-8">
            <div className="space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start pt-6">
                ...
                <button className="px-8 py-4 backdrop-blur-md bg-white/60 border-2 border-blue-600 text-blue-600 rounded-2xl font-semibold hover:bg-blue-600 hover:text-white transition-all duration-300 hover:scale-105 shadow-md hover:shadow-lg">
                  Let's Connect
                </button>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
            {skills.map((skill, index) => {
              ...
              return (
                ...
                >
                  {/* Glass effect card */}
                  <div className={`backdrop-blur-md bg-white/70 border border-gray-200/50 p-8 lg:p-10 rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 ${
                    isActive ? 'border-blue-500/50 shadow-xl' : ''
                  }`}>
                    <div className={`mb-6 transition-all duration-500 ${
                      isActive ? 'text-blue-600 scale-110' : 'text-gray-400 group-hover:text-blue-500'
                    }`}>
                    ...
                    <div className={`mt-6 h-1 bg-gradient-to-r from-blue-600 to-blue-500 rounded-full transition-all duration-500 ${
        ...
        <div className="mt-32 mb-20 flex justify-center">
          <div className="max-w-4xl w-full">
            <div className="backdrop-blur-md bg-white/70 border border-gray-200/50 px-12 py-12 lg:py-16 rounded-3xl shadow-xl text-center">
